...
class CashboxMealTicketContainerService
{
     ...
     * @param CashboxMealTicketContainer $cmtc
     * @return mixed
     * @throws \Doctrine\DBAL\DBALException
     */
    public function calculateTheoricalTotal(CashboxMealTicketContainer $cmtc)
    {
        $currentRestaurant = $this->restaurantService->getCurrentRestaurant();
        $ticketPaymentIds = implode(',', $this->getIdsFromArrayCollection($cmtc->getTicketPayments()));
        $theoricalTotal = 0;
