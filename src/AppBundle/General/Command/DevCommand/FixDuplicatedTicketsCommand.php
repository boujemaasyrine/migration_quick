...
class FixDuplicatedTicketsCommand extends ContainerAwareCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $sql = "SELECT id FROM ticket where num < 0 and date >= '2016-07-11'";
        ...
        // Delete mvmt records
        $sql2 = "delete from product_purchased_mvmt mvmt where mvmt.type = 'sold'
                    and mvmt.source_id in (select id from ticket_line tl where tl.ticket_id in (".$sql."));";
        ...
        $cbcs = $this->em->getRepository("Financial:CashboxCount")->createQueryBuilder("cashboxCount")
            ->getQuery()->getResult();
