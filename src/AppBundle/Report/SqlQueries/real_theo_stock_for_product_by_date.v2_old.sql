  ...
  *,
  COALESCE((
             ...
             WHERE dl.product_id = product AND
                   ...
                   d.date :: DATE > last_inventory_date :: DATE AND
  ...
  COALESCE((
             ...
             WHERE
               ...
               ls.entry :: DATE > last_inventory_date :: DATE AND
  ...
  COALESCE((
             ...
             WHERE rl.product_id = product AND
                   ...
                   r.date :: DATE > last_inventory_date :: DATE AND
             ...
             FROM (
                    ...
                    FROM
                      ...
                      JOIN ticket_line tl ON t.id = tl.ticket_id
                                             AND t.status <> -1 AND t.status <> 5 AND t.counted_canceled <> TRUE AND
                                             t.origin_restaurant_id = :restaurantID
                    WHERE qty > 0
  ...
  COALESCE((
             ...
             WHERE
               ...
               AND t.status NOT IN (-1, 5) AND t.counted_canceled <> TRUE AND t.origin_restaurant_id = :restaurantID
             GROUP BY pp.id
