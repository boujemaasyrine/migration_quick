SELECT
  COALESCE((
             ...
             WHERE dl.product_id = :productID AND
                   ...
                   d.date :: DATE >= :startDate :: DATE AND
  ...
  COALESCE((
             ...
             WHERE
               ...
               ls.entry :: DATE >= :startDate  :: DATE AND
  ...
  COALESCE((
             ...
             WHERE rl.product_id = :productID AND
                   ...
                   r.date :: DATE >= :startDate  :: DATE AND
             ...
             FROM (
                    ...
                    FROM
                      ...
                      JOIN ticket_line tl ON t.id = tl.ticket_id
                                             ...
                                             AND t.counted_canceled <> TRUE AND
                                             t.origin_restaurant_id=:restaurantID
                    WHERE qty > 0
  ...
  COALESCE((
             ...
             WHERE
               ...
               AND t.origin_restaurant_id=:restaurantID
             GROUP BY pp.id
