 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="AppBundle\Merchandise\Repository\RecipeLineRepository")
...
class RecipeLine
{
    ...
    /**
     * @var Recipe
     * @ORM\ManyToOne(targetEntity="AppBundle\Merchandise\Entity\Recipe", inversedBy="recipeLines")
     */
    private $recipe;
