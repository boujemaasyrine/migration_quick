...
use AppBundle\Supervision\Entity\ProductSupervisionTranslation;
...
class ProductSupervisionTranslationType extends AbstractType
{
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(
            array(
                'data_class' => ProductSupervisionTranslation::class,
            )
        );
    }
}
