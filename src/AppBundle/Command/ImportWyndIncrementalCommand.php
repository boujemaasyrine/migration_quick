...
class ImportWyndIncrementalCommand extends ContainerAwareCommand
{
    const INCREMENTAL_START=1911290001021464;
    ...
    {
        $this->setName('quick:wynd:import:incremental')
            ...
            ->setDescription('Import Wynd Tickets in the file starting invoiceNumber from an Increment');
        ...
        try {
            ...
            foreach ($ticketsList as $type => $tickets) {
                ...
                foreach ($tickets as $val) {
                    ...
                    $invoicenumber = $i+self::INCREMENTAL_START;
