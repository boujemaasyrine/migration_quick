...
function handleSortingTable() {
    ...
    var deliveryTable = $("#delivery-entry-table");
// do the work...
    deliveryTable.find("th").each(function (index, th) {
        if($(th).text().trim() === Translator.trans('delivery.entry.reference') || $(th).text().trim() === Translator.trans('delivery.entry.items'))
        {
            th.addEventListener('click', function() {
                ...
                if(this.asc == true)
                {
                    icon.addClass('header-arrow-up');
                }
                else
                {
                    icon.addClass('header-arrow-down');
                }
            });
        }
