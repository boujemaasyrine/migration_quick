        ...
        "columns": [
            ...
            },
            {
                ...
                "render": function (data, type, row) {
                    ...
                    var actionBtns =
                    "<div> " +
                        "<button type='button' class='btn blue  detail-btn'><span class='glyphicon glyphicon-eye-open'></span>"+Translator.trans('see', [], 'messages')+"</button> " +
                        "<button class=\"btn waves-effect btn-default btn-icon btn-download text-black dropdown-button\"\n" +
                        "                            data-activates=\"dropdown-download-detail-" + id + "\">\n" +
                        "                        <span>"+ Translator.trans('btn.download')+" </span>\n" +
                        "                    </button>\n" +
                        "                    <ul id=\"dropdown-download-detail-" + id + "\" class=\"dropdown-content\">\n" +
                        "                        <li>\n" +
                        "                            <a class=\"strech_btn text-black\" href=\"" + Routing.generate("download_order",{ 'order': id, 'download' : 1 }) + "\" id=\"export-detail-xls\">\n" +
                        ...
                        "                            </a></li>\n" +
                        "                        <li>\n" +
                        "                            <a class=\"strech_btn text-black\" href=\"" + Routing.generate("download_order",{ 'order': id, 'download' : 2 }) + "\" id=\"export-detail-pdf\">\n" +
