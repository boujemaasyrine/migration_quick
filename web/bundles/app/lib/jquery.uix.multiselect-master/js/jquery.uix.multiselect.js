 ...
 *
 *
 * **** ****** *****  THIS FILE WAS MODIFIED BY AMJED NOUIRA <amjed.nouira@talan.tn> ***** ****** ****
 * **** ****** *****  CHANGES ARE AT LINES 857-858  880-881 ***** ******* ********
 * *** ADDING if (e[$(this).data('element-index')] != undefined){ in the line 985, sometimes it can be undefined *****
 *
 *
 */
...
;(function($, window, undefined) {
    ...
    OptionCache.prototype = {
        ...
        _createElement: function(optElement, optGroup) {
            ...
            /*** This two line were added By AMJED to add the same attributes of the original option to the target div ***/
            var originalOption = optElement[0];
            var attrs = originalOption.attributes;
            ...
            /** These 2 lines were added BY AMJED **/
            $.each(attrs,function(key,value){
                e.attr(value.name,$(value).val());
            });
        ...
        _reorderSelected: function(optGroup) {
            ...
            $('.option-element', g['selected'].listContainer).each(function() {
                if (e[$(this).data('element-index')] != undefined){
