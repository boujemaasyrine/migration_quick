...
$(function () {
    ...
    $(document).on('click', '#addForeignCurrencyExchangeRate', function(e) {
        var title = Translator.trans('foreign_currency.add_new_foreign_currency');

        var sourceBody   = $("#foreignCurrencyModalBody").html();
        var templateBody = Handlebars.compile(sourceBody);
        var contextBody = {title: "My New Post", body: "This is my first post!"};
        ...
        var contextFooter = {title: "My New Post", body: "This is my first post!"};
