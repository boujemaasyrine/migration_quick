...
//    var new_diff = Math.random() * (end - start) + start;
//    var date = moment.unix(new_diff);
//    return date;
//}
//
//function generateData(prototype, count) {
//    var result = [];
//    for(var i= 0;i < count; i++) {
//        var obj = {};
//        for(var key in prototype) {
//            if(key !== "date") {
//                obj[key] = generateRandomNumber();
//            } else {
//                obj[key] = randomTime(parseInt(moment("1990-01-01").format("X")), parseInt(moment("2017-11-01").format('X'))).toString()
//            }
//        }
//        result.push(obj);
//    }
